...
```{r question-1-plot-1, echo = FALSE, warning = FALSE, message = FALSE, fig.height = 0.1, fig.width = 10}
parks_q1 <- parks %>%
...
---
# Question 1 
```{r question 1 plot 2, echo = FALSE, warning = FALSE, message = FALSE, fig.width = 10}
