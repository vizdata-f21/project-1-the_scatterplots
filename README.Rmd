...
To answer our first question, we used the ` r parks` dataset and analyzed the 
relationship between the variables ` r spend_per_resident_data`, ` r city`, 
`r med_park_size_data`, and `r year`. We thought it would be interesting to look 
...
NAs for ` r spend_per_resident_data`, ` r city`, and `r med_park_size_data`. 
This left us with a data frame with 4 columns: ` r spend_per_resident_data`, 
` r city`, `r med_park_size_data`, and `r year`. At this point, all that was 
...
q1_plot<- ggplot(parks_q1, aes(x = spend_per_resident, y = med_park_size_data, 
>>>>>>> b9bcdbb74775777f4687748ccb35c58cc7c590c5
                               group = city)) + 
