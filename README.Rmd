...
parks_2020_long <- parks_2020 %>%
  ...
  pivot_longer(cols = c(basketball_data, playground_data, restroom_data),
               names_to = "amenity",
               values_to = "per_10k") %>%
  mutate(city = case_when(as.character(city) == "Charlotte/Mecklenburg County" ~ "Charlotte",
                          as.character(city) == "Arlington, Virginia" ~ "Arlington, VA",
